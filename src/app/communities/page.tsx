...
import { Shapes, Search, PlusCircle, Users, MessageCircle, Target, Pin, MessagesSquare, CalendarDays, Settings2, Library } from "lucide-react";
...
export default function CommunitiesPage() {
  ...
  useEffect(() => {
    ...
    if (currentTab && ['your-communities', 'discover'].includes(currentTab)) {
      ...
      // Default to 'your-communities' if no valid tab is in URL
      setActiveTab('your-communities');
      // Optionally update URL to reflect default tab, uncomment if desired
      // router.replace('/communities?tab=your-communities', { scroll: false });
    }
  }, [searchParams, router]);
